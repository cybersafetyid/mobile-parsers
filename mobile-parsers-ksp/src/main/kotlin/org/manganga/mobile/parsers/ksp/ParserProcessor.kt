package org.manganga.mobile.parsers.ksp
...
class ParserProcessor(
	...
	override fun process(resolver: Resolver): List<KSAnnotated> {
		val symbols = resolver
			.getSymbolsWithAnnotation("org.manganga.mobile.parsers.MangaSourceParser")
		...
		val factoryFile = try {
			codeGenerator.createNewFile(
				...
				packageName = "org.manganga.mobile.parsers",
		...
		val sourcesFile = try {
			codeGenerator.createNewFile(
				dependencies = dependencies,
				packageName = "org.manganga.mobile.parsers.model",
